...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    // Create GL renderer correctly for OGL handling transparency
    ...
    function resize() {
      // Small delay on resize often helps robust rendering updates
      setTimeout(() => {
        if (!containerRef.current) return;
    ...
    function update(time) {
      ...
      // Safety check if program got cleaned up
  ...
  return <div ref={containerRef} className="soft-aurora-container pointer-events-none" />;
}
